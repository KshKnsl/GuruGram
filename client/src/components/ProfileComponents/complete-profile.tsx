...
export default function CompleteProfile() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-gray-950 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg bg-white dark:bg-gray-900 border border-amber-500/20 overflow-hidden shadow-lg">
        <div className="p-8 md:p-10 text-center">
          <SectionTitle>Complete Your Mentor Profile</SectionTitle>

          <div className="w-14 h-14 mx-auto border border-amber-500/30 bg-amber-500/10 flex items-center justify-center my-6">
          ...
          <Button asChild className="clip-skew w-full" variant="default">
            <Link to="/profile-completion" className="flex items-center justify-center gap-2">
              Start Profile Setup
