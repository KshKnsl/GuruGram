  ...
  return (
    <div className="mt-16">
      ...
      <form onSubmit={handleSubmit} className="border-t border-amber-500/20 pt-8">
        ...
        <button
          type="submit"
          className="mt-3 clip-skew inline-flex items-center gap-2 px-7 py-3 text-xs font-medium tracking-widest uppercase bg-amber-500 hover:bg-amber-400 text-gray-900 transition-all duration-300 hover:-translate-y-0.5"
        >
